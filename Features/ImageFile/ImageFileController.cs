...
namespace Alloy.Features.ImageFile
{
    /// <summary>
    /// Controller for the image file.
    /// </summary>
    public class ImageFileController : PartialContentController<Models.Media.ImageFile>
    {
        ...
        public override ActionResult Index(Models.Media.ImageFile currentContent)
        {
