...
namespace Alloy.Features.ContactBlock
{
    public class ContactBlockController : BlockController<Models.Blocks.ContactBlock>
    {
        ...
        public override ActionResult Index(Models.Blocks.ContactBlock currentBlock)
        {
            ...
            ViewData.GetEditHints<ContactBlockModel, Models.Blocks.ContactBlock>()
        ...
        private IHtmlString GetLinkUrl(Models.Blocks.ContactBlock contactBlock)
        {
